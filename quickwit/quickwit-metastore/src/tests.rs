...
pub mod test_suite {
    ...
    use quickwit_proto::metastore::{
        ...
        ListAllSplitsRequest, ListDeleteTasksRequest, ListIndexesMetadatasRequest,
    ...
    use crate::{
        ...
        ListIndexesMetadataRequestExt, ListIndexesResponseExt, ListSplitsQuery,
        ListSplitsRequestExt, ListSplitsResponseExt, Split, SplitMaturity, SplitMetadata,
    ...
    pub async fn test_metastore_create_index<MetastoreToTest: MetastoreService + DefaultForTest>() {
    ...
    pub async fn test_metastore_index_exists<MetastoreToTest: MetastoreService + DefaultForTest>() {
        let mut metastore = MetastoreToTest::default_for_test().await;
    ...
    pub async fn test_metastore_list_indexes<MetastoreToTest: MetastoreService + DefaultForTest>() {
        ...
        let indexes_count = metastore
            .list_indexes_metadatas(
                ListIndexesMetadatasRequest::try_from_list_indexes_query(list_index_metadata_query)
                    .unwrap(),
            )
            .await
            .unwrap()
        ...
        let indexes_count = metastore
            .list_indexes_metadatas(
                ListIndexesMetadatasRequest::try_from_list_indexes_query(list_indexes_query)
                    .unwrap(),
            )
            .await
            .unwrap()
    ...
    pub async fn test_metastore_delete_index<MetastoreToTest: MetastoreService + DefaultForTest>() {
        let mut metastore = MetastoreToTest::default_for_test().await;
